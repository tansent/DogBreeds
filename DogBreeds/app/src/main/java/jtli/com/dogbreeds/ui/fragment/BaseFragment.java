package jtli.com.dogbreeds.ui.fragment;
...
public abstract class BaseFragment<P extends BasePresenter> extends Fragment implements LifeSubscription, Stateful {
    ...
    private boolean isFirst = true; //only loading once
    protected View contentView;
    private Unbinder bind;
    private boolean isPrepared = false;
    private boolean mIsVisible = false;     // fragment visible or not

    /**
     * Fragment lazy loading.
     * this method invoked before onCreateView
     */
    @Override
    public void setUserVisibleHint(boolean isVisibleToUser) {
        super.setUserVisibleHint(isVisibleToUser);
        if (getUserVisibleHint()) {//fragment visible
            mIsVisible = true;
            onVisible();
        } else {//fragment invisible
            mIsVisible = false;
            onInvisible();
        }
    }
